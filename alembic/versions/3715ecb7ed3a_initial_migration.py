...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_gdpr_deletion_logs_certificate_id"),
        "gdpr_deletion_logs",
        ["certificate_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_gdpr_deletion_logs_resident_id"),
        "gdpr_deletion_logs",
        ["resident_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_gdpr_deletion_logs_tenant_id"),
        "gdpr_deletion_logs",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "baseline_last_calculated_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_residents_tenant_id"), "residents", ["tenant_id"], unique=False
    )
    op.create_table(
        "webhooks",
        sa.Column("id", sa.String(length=32), nullable=False),
    ...
    op.create_index(
        "ix_alerts_resident_dismissed",
        "alerts",
        ["resident_id", "dismissed"],
        unique=False,
    )
    op.create_index(op.f("ix_alerts_tenant_id"), "alerts", ["tenant_id"], unique=False)
    op.create_index(
        "ix_alerts_tenant_tier", "alerts", ["tenant_id", "tier"], unique=False
    )
    op.create_table(
        "observations",
        sa.Column("id", sa.String(length=32), nullable=False),
    ...
    op.create_index(
        "ix_observations_resident_observed_at",
        "observations",
        ["resident_id", "observed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_observations_tenant_id"), "observations", ["tenant_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_gdpr_deletion_logs_tenant_id"), table_name="gdpr_deletion_logs"
    )
    op.drop_index(
        op.f("ix_gdpr_deletion_logs_resident_id"), table_name="gdpr_deletion_logs"
    )
    op.drop_index(
        op.f("ix_gdpr_deletion_logs_certificate_id"), table_name="gdpr_deletion_logs"
    )
