...
class GDPRDeletionLog(Base):
    ...
    id = Column(String, primary_key=True, default=lambda: f"gdl_{ulid.new().str.lower()}")
    tenant_id = Column(String, ForeignKey("tenants.id"), nullable=False, index=True)
    
    resident_id = Column(String, nullable=False, index=True) # ID of the now-deleted resident
